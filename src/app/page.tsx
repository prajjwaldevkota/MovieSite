      ...
      <header className="z-10 sticky top-0 backdrop-blur-3xl border-b border-white/10 shadow-2xl">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight bg-gradient-to-r from-purple-400 via-indigo-400 to-violet-400 bg-clip-text text-transparent drop-shadow-2xl mb-2 animate-pulse">
              CineStream
            </h1>
